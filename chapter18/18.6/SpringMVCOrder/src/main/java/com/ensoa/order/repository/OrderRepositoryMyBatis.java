...
import com.ensoa.order.entity.mapper.OrderItemMapperWithAnnotation;
import com.ensoa.order.entity.mapper.OrderMapperWithAnnotation;
...
public class OrderRepositoryMyBatis implements OrderRepository {
	...
	@Autowired
	private OrderMapperWithAnnotation orderMapper;
	@Autowired
	private OrderItemMapperWithAnnotation itemMapper;
