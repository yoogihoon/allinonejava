...
public class CustomerServiceTxAnnotation implements CustomerService {
	private static final Logger logger = LoggerFactory.getLogger(CustomerServiceTxAnnotation.class);
	@Resource(name = "customerRepository")
	private CustomerRepository repository;

	public CustomerServiceTxAnnotation() {
	}
	
	public CustomerServiceTxAnnotation(CustomerRepository repository) {
