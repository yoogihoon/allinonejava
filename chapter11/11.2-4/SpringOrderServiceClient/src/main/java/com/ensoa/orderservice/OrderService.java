 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://orderservice.ensoa.com/", wsdlLocation = "http://localhost:8080/orderservice/OrderService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://orderservice.ensoa.com/", "OrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/orderservice/OrderService?WSDL");
     ...
     * 
     * @return
     *     returns OrderSerivceEndpoint
     */
    @WebEndpoint(name = "OrderSerivceEndpointPort")
    public OrderSerivceEndpoint getOrderSerivceEndpointPort() {
        return super.getPort(new QName("http://orderservice.ensoa.com/", "OrderSerivceEndpointPort"), OrderSerivceEndpoint.class);
    }
     ...
     */
    @WebEndpoint(name = "OrderSerivceEndpointPort")
    public OrderSerivceEndpoint getOrderSerivceEndpointPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://orderservice.ensoa.com/", "OrderSerivceEndpointPort"), OrderSerivceEndpoint.class, features);
    }
